...
const URL = 'mongodb://cboard:cboard@ds159200.mlab.com:59200/cboard';

const createDocuments = function (db, callback) {
  let collection = db.collection('jduser');
 ...
 * (since this part will only be available in the dev mode and not be deployed.)
 */
