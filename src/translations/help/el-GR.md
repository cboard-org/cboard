...
Το Cboard είναι μια δωρεάν διαδικτυακή εφαρμογή για παιδιά και ενήλικες με προβλήματα ομιλίας και γλώσσας, διευκολύνοντας την επικοινωνία με τις εικόνες και το κείμενο σε ομιλία. <iframe width="420" height="315" src="https://www.youtube.com/embed/pjoLEtiFf2A" frameborder="0" allowfullscreen mark="crwd-mark"></iframe> 
...
8. Τέλος, επιλέξτε το σύμβολο του μικροφώνου και καταγράψτε, μπορείτε να εγγράψετε πολλές φορές και να το αναπαραγάγετε πριν το αποθηκεύσετε στην πλακέτα.
    ...
    Εάν έχετε επιλέξει πολλά σύμβολα, χρησιμοποιήστε το NEXT για να μεταβείτε στο επόμενο σύμβολο και να επαναλάβετε τη διαδικασία. <iframe width="420" height="315" src="https://www.youtube.com/embed/KZwCP4PkM4I" frameborder="0" allowfullscreen mark="crwd-mark"></iframe> 
...
Για να προσωποποιήσετε το χαρτόνι, επιλέξτε το μολύβι και θα μπορείτε να αλλάξετε την ετικέτα, να ανεβάσετε μια εικόνα και να προσθέσετε την ένδειξη Vocalization. <iframe width="420" height="315" src="https://www.youtube.com/embed/sRnVvafKBLM" frameborder="0" allowfullscreen mark="crwd-mark"></iframe> 
