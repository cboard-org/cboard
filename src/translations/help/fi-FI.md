...
* [Rekisteröinti ja kirjautuminen](#Registrationandlogin) 
    ...
    * [Voinko rekisteröidä itseni sosiaalisen median tileillä?](#CanIregistermyselfusingmysocialmediaaccounts)
...
* [ominaisuudet](#Features) 
    ...
    * [Selaus käyttöliittymän kautta](#Navigationthroughtheinterface)
* [asetukset](#Settings) 
    * [Kuinka pääsen käsiksi Cboard-asetuksiin?](#HowdoIaccesssettingsinCboard)
    * [Kuinka tulostan korttipakettini pahviksi?](#HowdoIprintmyboardsetinCboard)
    * [Kuinka näen Cboardin koko näytössä?](#HowdoIseeCboardinfullscreen)
    * [Kuinka jaan hallituksen?](#HowdoIshareaboard)
* [Puhuminen](#Talking) 
    * [Kuinka lisätä henkilökohtaisesti tallennetun äänen Cboard-symboliin?](#HowdoIaddapersonallyrecordedvoicetosymbolsonCboard)
    * [Kuinka vaihdan toiseen ääneen?](#HowdoIswitchtoadifferentvoice)
    * [Kuinka voin muuttaa äänen kuulostamista?](#HowdoIchangehowavoicesounds)
* [Taulun muokkaaminen](#BoardEditing) 
    * [Kuinka luoda tyhjä taulu?](#HowdoIcreateanemptyboard)
    * [Kuinka räätälöin olemassa oleva Cboard-hallitus?](#HowdoIpersonalizeanexistingboardinCboard)
    * [Voinko käyttää omia kuviani editoidessani taulua?](#CanIusemyownpictureswheneditingaboard)
    * [Voinko muuttaa taulun elementtien järjestystä?](#CanIchangetheorderingoftheelementsinaboard)
    * [Kuinka valitsen useita muokattavia elementtejä?](#HowdoIselectmultipleelementstoedit)
    * [Kuinka voin löytää uusia symboleja muokatessani laattaa?](#FindSymbols)
* [Vienti ja tuonti](#Exportandimport) 
    * [Kuinka viedä levyni kartonkiin?](#HowdoIexportmyboardinCboard)
    * [Kuinka tuon levyn Cboardiin?](#HowdoIimportaboardintoCboard)
...
* [Näyttöominaisuudet](#Displaycapabilities) 
    ...
    * [Voinko muuttaa Cboard-painikkeiden kokoa?](#CanIresizebuttonsonCboard)
* [skannaus](#Scanning) 
    * [Voinko käyttää skannaustekniikoita pääsyyn symboleihin?](#CanIusescanningtechniquestoaccesssymbols)
