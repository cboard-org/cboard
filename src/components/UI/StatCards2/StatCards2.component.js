      ...
      <Grid item xs={12} md={6}>
        <Card elevation={3} className="p-4">
          <div className="flex items-center">
            ...
            >
              <Icon className="text-green">navigation</Icon>
            </Fab>
      ...
      <Grid item xs={12} md={6}>
        <Card elevation={3} className="p-4">
          <div className="flex items-center">
            ...
            >
              <Icon className="text-error">record_voice_over</Icon>
            </Fab>
            <h5 className="font-medium text-error m-0 ml-3">Speech Events</h5>
          </div>
          <div className="pt-4 flex items-center">
            <h2 className="m-0 text-muted flex-grow">2.8K</h2>
        ...
        <Card elevation={3} className="p-4">
          <div className="flex items-center">
            <Fab
              ...
              className="bg-light-error circle-44 box-shadow-none overflow-hidden"
            >
              <Icon className="text-error">edit</Icon>
            </Fab>
            <h5 className="font-medium text-error m-0 ml-3">Editing Events</h5>
          </div>
          <div className="pt-4 flex items-center">
            <h2 className="m-0 text-muted flex-grow">348</h2>
            <div className="ml-3 small-circle bg-error text-white">
              <Icon className="small-icon">expand_less</Icon>
            </div>
            <span className="text-13 text-error ml-1">(+21%)</span>
