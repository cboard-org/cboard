...
export const GET_API_BOARD_SUCCESS = 'cboard/Board/GET_API_BOARD_SUCCESS';
export const GET_API_BOARD_FAILURE = 'cboard/Board/GET_API_BOARD_FAILURE';
export const GET_API_BOARD_STARTED = 'cboard/Board/GET_API_BOARD_STARTED';
